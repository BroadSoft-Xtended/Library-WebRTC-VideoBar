...
function VideobarView(eventbus, sound, timerView, videobar) {
  var self = {};
  ...
  var toggleSelfView = function(selfViewVisible) {
    ...
    eventbus.viewChanged({visible: self.selfViewVisible, viewName: 'video'});
  };
  ...
  self.enableScreenSharing = function(enabled) {
    ...
    eventbus.viewChanged({visible: enabled, viewName: 'screenshare'});
  };
  ...
  self.enableFullScreen = function(enable) {
    ...
    eventbus.viewChanged({viewName: 'fullscreen', visible: enable});
  };
  ...
  self.enableSound = function(enable) {
    ...
    eventbus.viewChanged({viewName: 'sound', visible: enable});
  };
