...
function VideoBarView(eventbus, sound, timerView) {
  var self = {};
  ...
  var updateClasses = function(){
    var classes = ['videoBar', sipstack.callState].concat(configuration.enabledFeatures());
    self.view.attr("class", classes.join(" "));
  };
